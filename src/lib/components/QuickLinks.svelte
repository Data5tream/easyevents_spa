...
<style>
  ...
  :global(.link-card.events) {
    ...
    background: linear-gradient(315deg, rgb(110, 49, 185) 0%, rgba(45, 113, 182, 1) 40%, rgba(45, 113, 182, 1) 100%);
  }
  :global(.link-card.participants) {
    background: rgb(182, 45, 171);
    background: linear-gradient(315deg, rgb(110, 49, 185) 0%, rgba(182, 45, 171, 1) 40%, rgba(182, 45, 171, 1) 100%);
  }
</style>
